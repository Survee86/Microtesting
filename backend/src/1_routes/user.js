...
import { getCurrentUser }           from '../3_controllers/user.js';
...
import { updateUserProfile }        from '../3_controllers/user.js';

const router = express.Router();

router.get  ('/', authenticate, getCurrentUser);
router.patch('/', authenticate, mongoHealthMiddleware, validateUpdateForm, updateUserProfile );
